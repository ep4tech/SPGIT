...
const MonitoringSupportPage = () => {
  ...
  return (
    <Box p={3}>
      ...
      <Paper sx={{ p: 2, mb: 2 }}>
        <TextField label={t('monitoring.support.enter')} fullWidth value={request} onChange={e => setRequest(e.target.value)} onKeyPress={e => e.key === 'Enter' && handleSend()} sx={{ mb: 2 }} multiline rows={4} />
