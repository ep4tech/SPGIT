...
const content = [
  'مدخلات لحساب تكلفة تنفيذ كل مشروع/برنامج.',
  'أداة توزيع الميزانية على سنوات التنفيذ (خطط قصيرة وطويلة).',
  'نظام لاعتماد الميزانية ومراجعتها من الإدارة العليا.'
];
